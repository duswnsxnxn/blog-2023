...
<%
	...
	BoardBean bean = bdao.getOneUpateBoard(num);
%>
...
<td width="480" colspan="3"> &nbsp; <input type="password" name="password" value="<%=bean.getSubject() %>" size="60"></td>
</tr>
<tr height="40">
<td width="120" align="center">글내용</td>
<td width="480" colspan="3"> &nbsp; <textarea rows="10" cols="60" name="content" align="left"><%=bean.getContent() %>
</textarea></td>
</tr>
<tr height="40">
