...
<td width="480" colspan="3"> &nbsp; <textarea rows="10" cols="60" name="content" align="left">${bean.content }
</textarea></td>
</tr>
<tr height="40">
...
<input type="button" onclick="location.href='BoardListCon'" value="전체글보기"></td>
</tr>
